...
export default function AddPropertyPage() {
  ...
  const { user, isAuthenticated, addProperty } = useStore();
  ...
  if (!isAuthenticated) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="text-slate-600 mb-8">You need a property lister account to list a property.</p>
        <button
          onClick={() => navigate('/')}
  ...
  if (user?.role === 'viewer') {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <FiAlertCircle className="text-5xl text-amber-500 mx-auto mb-4" />
        <h1 className="text-3xl font-bold text-slate-800 mb-4">Lister Account Required</h1>
        <p className="text-slate-600 mb-8">Switch to a property lister account to publish listings.</p>
        <button
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const newProperty = {
        ...
        isApproved: true,
        isFeatured: false,
        isListerVerified: user?.isVerifiedLister ?? false,
      };
    ...
    <div className="bg-slate-50 py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl font-bold text-slate-800 mb-2">List Your Property</h1>
          <p className="text-slate-600">Publish up to 10 images and reach thousands of verified buyers</p>
        </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="e.g., Beautiful 3 Bedroom House in Karen"
